...
LocalPlayer.CharacterAdded:Connect(function(newCharacter)
    ...
    -- Connect Died event for new Humanoid
    Humanoid.Died:Connect(function()
        cleanupCouch()
    end)
end)

-- Connect Died event for initial Humanoid, if it exists
if Humanoid then
    Humanoid.Died:Connect(function()
        cleanupCouch()
    end)
                            ...
                            if targetPlayer and targetPlayer.Character and targetPlayer.Character:FindFirstChild("HumanoidRootPart") then
                                ...
                                if targetHumanoid and targetHumanoid.Sit then
                                    if character.Humanoid then
                                        ...
                                        print("Player sat down, sending bus to void!")
                                        task.wait(0.2)
        ...
        if Check() then
            ...
            if not House then
                ...
                if #availableHouses > 0 then
                    ...
                    -- Fire remote event to build house
                    task.wait(0.5)
                    local args = {
...
Troll:AddButton({
    ...
    Callback = function()
        ...
        print("Player is locked at safe coordinate.")
...
Description = "To use, I recommend getting near doors first, then after they come to you, click on the player you want to fling",
  Callback = function()
local Players = game:GetService("Players")
...
game:GetService("StarterGui"):SetCore("SendNotification",{Title="Duping",Text="Do NOT click anything while duping.", Button1 = "Got it" ,Duration=5})
game:GetService("StarterGui"):SetCore("SendNotification",{Title="Dupe Script",Text="It will break the script and you will need to rejoin.", Button1 = "Got it" ,Duration=5}) 
duping = true
...
picktoolremote = game:GetService("ReplicatedStorage").RE:FindFirstChild("1Too1l")
cleartoolremote = game:GetService("ReplicatedStorage").RE:FindFirstChild("1Clea1rTool1s")
game:GetService("StarterGui"):SetCore("SendNotification",{Title="Duping",Text="Do not click anything", Button1 = "Got it" ,Duration=5})
game:GetService("StarterGui"):SetCore("SendNotification",{Title="Duping",Text="Please wait", Button1 = "OK" ,Duration=5})
duping = true
oldcf = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
if game.Players.LocalPlayer.Character.Humanoid.Sit == true then
    task.wait()
...
CarTab:AddParagraph({"Note:", "Recommended to use twice to ensure all vehicles are removed"})
...
CarTab:AddParagraph({"Note:", "Pulls all cars on the server to you"})
...
CarTab:AddParagraph({"Note", "Enabling this allows you to fly with your car"})
...
CarTab:AddParagraph({"Note:", "Spam multiple cars"})
...
local playerChild = ChildTab:AddDropdown({
    Name = "Select a player to follow",
    Options = players,
    Default = "",
...
Tab:AddButton({
    Name = "Mini Stallion",
    Description = "Mini stallion avatar",
    Callback = function()
        local ReplicatedStorage = game:GetService("ReplicatedStorage")
        local StarterGui = game:GetService("StarterGui")
...
Tab:AddButton({
    Name = "Stick",
    Description = "Stick figure avatar",
    Callback = function()
        local ReplicatedStorage = game:GetService("ReplicatedStorage")
        local StarterGui = game:GetService("StarterGui")
