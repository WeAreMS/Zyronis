if IY_LOADED and not _G.IY_DEBUG then
	-- error("Zyronis Panel is already running!", 0)
	return
end
...
local iyassets = {
	...
	["infiniteyield/assets/logo.png"] = "rbxassetid://6675147490",
...
Title.Parent = Holder
Title.Active = true
Title.BackgroundColor3 = Color3.fromRGB(140, 10, 25)
Title.BorderSizePixel = 0
Title.Size = UDim2.new(0, 250, 0, 20)
Title.Font = Enum.Font.SourceSansBold
Title.TextSize = 18
Title.Text = "Zyronis Panel " .. currentVersion
...
Cmdbar.Text = ""
Cmdbar.ZIndex = 10
Cmdbar.PlaceholderText = "Zyronis / Command Bar"
...
CMDsF.ScrollBarImageColor3 = Color3.fromRGB(180, 20, 40)
...
SettingsHolder.ScrollBarImageColor3 = Color3.fromRGB(180, 20, 40)
...
Prefix.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
PrefixBox.BackgroundColor3 = Color3.fromRGB(180, 20, 40)
...
StayOpen.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
Button.BackgroundColor3 = Color3.fromRGB(180, 20, 40)
Button.BorderSizePixel = 0
...
Title_2.BackgroundColor3 = Color3.fromRGB(140, 10, 25)
...
Holder_2.ScrollBarImageColor3 = Color3.fromRGB(180, 20, 40)
...
Example_2.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
Text_3.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
Delete_2.BackgroundColor3 = Color3.fromRGB(180, 20, 40)
...
Dark_3.Active = true
Dark_3.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
BindTo.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
BindTriggerSelect.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
Add_2.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
Select.BackgroundColor3 = Color3.fromRGB(180, 20, 40)
...
ClickDelete.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
Select_2.BackgroundColor3 = Color3.fromRGB(180, 20, 40)
...
Cmdbar_2.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
Cmdbar_3.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
CreateToggle.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
Button_2.BackgroundColor3 = Color3.fromRGB(180, 20, 40)
...
shadow_2.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
Close_3.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
Delete_5.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
Part.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
Holder_4.ScrollBarImageColor3 = Color3.fromRGB(180, 20, 40)
...
Example_4.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
Text_5.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
Delete_6.BackgroundColor3 = Color3.fromRGB(180, 20, 40)
...
TP.Name = "TP"
TP.Parent = Text_5
TP.BackgroundColor3 = Color3.fromRGB(180, 20, 40)
...
Close_2.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
Delete_3.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
Holder_3.ScrollBarImageColor3 = Color3.fromRGB(180, 20, 40)
...
Example_3.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
Text_4.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
Delete_4.BackgroundColor3 = Color3.fromRGB(180, 20, 40)
...
Close_4.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
Add_3.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
Holder_5.ScrollBarImageColor3 = Color3.fromRGB(180, 20, 40)
...
Example_5.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
Text_6.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
Delete_7.BackgroundColor3 = Color3.fromRGB(180, 20, 40)
...
Dark_2.Active = true
Dark_2.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
AddPlugin.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
FileName.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
shadow_3.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
ChoosePart.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
CopyPath.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
shadow_4.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
		...
		if readSuccess then
			if out ~= nil and tostring(out):gsub("%s", "") ~= "" then
				local success, response = pcall(function()
					...
					if vtype(json.bgColor, "table") then
						savedBgColor = Color3.new(json.bgColor[1], json.bgColor[2], json.bgColor[3])
					end
				end)
				if not success then
...
function updatesaves()
	if nosaves == false and writefileExploit() then
		local update = {
			...
			currentScroll = {currentScroll.R,currentScroll.G,currentScroll.B};
			eventBinds = eventEditor.SaveData();
			bgColor = savedBgColor and {savedBgColor.R, savedBgColor.G, savedBgColor.B} or nil;
		}
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			...
			local writelogs = '-- Zyronis Panel Chat logs for "'..placeName..'"\n'
			for _, child in pairs(scroll_2:GetChildren()) do
				writelogs = writelogs..'\n'..child.Text
			end
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = 'Invite to the Zyronis Panel discord server.'}
...
CMDs[#CMDs + 1] = {NAME = 'background / bg [color/r g b]', DESC = 'Changes the panel background color (e.g. background purple, bg 255 0 0)'}
CMDs[#CMDs + 1] = {NAME = 'resetbackground / resetbg', DESC = 'Resets the panel background color to default black'}
...
Cmdbar.Focused:Connect(function()
	...
	tabComplete = UserInputService.InputBegan:Connect(function(input, gameProcessed)
		if Cmdbar:IsFocused() then
			-- Tab tusu gameProcessed olsa bile calıssin (textbox odakta oldugunda)
...
addcmd('keepiy', {}, function(args, speaker)
	if queueteleport then
		KeepInfYield = true
		notify('KeepIY','Zyronis Panel will now run after you teleport')
		updatesaves()
	else
...
addcmd('unkeepiy', {}, function(args, speaker)
	if queueteleport then
		KeepInfYield = false
		notify('KeepIY','Zyronis Panel will no longer run after you teleport')
		updatesaves()
	else
		notify('Incompatible Exploit','Your exploit does not support this command (missing queue_on_teleport)')
	end
...
local colorNames = {
	...
	["green"]     = Color3.fromRGB(0, 180, 0),
	["blue"]      = Color3.fromRGB(0, 0, 220),
	["yellow"]    = Color3.fromRGB(255, 220, 0),
	["orange"]    = Color3.fromRGB(255, 140, 0),
	["purple"]    = Color3.fromRGB(150, 0, 220),
	...
	["lime"]      = Color3.fromRGB(50, 220, 50),
	["teal"]      = Color3.fromRGB(0, 160, 160),
	["navy"]      = Color3.fromRGB(0, 0, 128),
	["magenta"]   = Color3.fromRGB(220, 0, 220),
	["violet"]    = Color3.fromRGB(130, 0, 200),
	["indigo"]    = Color3.fromRGB(75, 0, 130),
	["gold"]      = Color3.fromRGB(255, 200, 0),
	["silver"]    = Color3.fromRGB(192, 192, 192),
	["crimson"]   = Color3.fromRGB(180, 0, 30),
	["coral"]     = Color3.fromRGB(255, 127, 80),
	["salmon"]    = Color3.fromRGB(250, 128, 114),
	["turquoise"] = Color3.fromRGB(64, 224, 208),
	["beige"]     = Color3.fromRGB(245, 220, 180),
	["maroon"]    = Color3.fromRGB(128, 0, 0),
	["olive"]     = Color3.fromRGB(128, 128, 0),
	-- Turkce karsiliklar
	["mor"]       = Color3.fromRGB(150, 0, 220),
	["kirmizi"]   = Color3.fromRGB(200, 0, 0),
	["yesil"]     = Color3.fromRGB(0, 180, 0),
	["mavi"]      = Color3.fromRGB(0, 0, 220),
	["sari"]      = Color3.fromRGB(255, 220, 0),
	["turuncu"]   = Color3.fromRGB(255, 140, 0),
	["pembe"]     = Color3.fromRGB(255, 105, 180),
	["beyaz"]     = Color3.fromRGB(255, 255, 255),
	["siyah"]     = Color3.fromRGB(0, 0, 0),
	["gri"]       = Color3.fromRGB(100, 100, 100),
	["lacivert"]  = Color3.fromRGB(0, 0, 128),
	["altin"]     = Color3.fromRGB(255, 200, 0),
	["gumus"]     = Color3.fromRGB(192, 192, 192),
	["bordo"]     = Color3.fromRGB(128, 0, 0),
}

local defaultBGColor = Color3.fromRGB(10, 10, 10)
local defaultShade2Color = Color3.fromRGB(20, 20, 20)
savedBgColor = savedBgColor or nil  -- kayıt dosyasından gelebilir

local function applyBgColor(newColor)
	for _, frame in pairs(shade1) do
		if frame and frame.Parent then
			pcall(function() frame.BackgroundColor3 = newColor end)
		end
	end
	for _, frame in pairs(shade2) do
		if frame and frame.Parent then
			pcall(function()
				local r = math.clamp(newColor.R * 255 + 12, 0, 255)
				local g = math.clamp(newColor.G * 255 + 12, 0, 255)
				local b = math.clamp(newColor.B * 255 + 12, 0, 255)
...
-- Script yeniden başlatılınca kaydedilen rengi uygula
if savedBgColor then
	task.spawn(function()
		wait(0.5) -- GUI yüklenene kadar bekle
		applyBgColor(savedBgColor)
	end)
end

addcmd('background', {'bg'}, function(args, speaker)
	local newColor = nil

	if args[1] and isNumber(args[1]) and args[2] and isNumber(args[2]) and args[3] and isNumber(args[3]) then
		local r = math.clamp(tonumber(args[1]), 0, 255)
		local g = math.clamp(tonumber(args[2]), 0, 255)
		local b = math.clamp(tonumber(args[3]), 0, 255)
		newColor = Color3.fromRGB(r, g, b)
	elseif args[1] then
		local colorKey = args[1]:lower()
		newColor = colorNames[colorKey]
		if not newColor then
			notify('Background', 'Bilinmeyen renk: "'..args[1]..'"\nOrnek: bg purple, bg red, bg 255 0 128')
			return
		end
	else
		notify('Background', 'Kullanim: background [renk] veya background [R] [G] [B]\nOrnek: background purple | bg 255 0 0')
		return
	end

	applyBgColor(newColor)
	savedBgColor = newColor  -- kaydet
	updatesaves()

	local colorStr = args[1]:lower()
	if isNumber(args[1]) then
		colorStr = args[1]..", "..args[2]..", "..(args[3] or "0")
	end
	notify('Background', 'Renk degistirildi ve kaydedildi: ' .. colorStr)
end)

addcmd('resetbackground', {'resetbg'}, function(args, speaker)
	applyBgColor(defaultBGColor)
	for _, frame in pairs(shade2) do
		if frame and frame.Parent then
			pcall(function() frame.BackgroundColor3 = defaultShade2Color end)
		end
	end
	savedBgColor = nil
	updatesaves()
	notify('Background', 'Arka plan varsayilana sifirlanpanel ve kaydedildi.')
end)
...
if IsOnMobile then
	...
	QuickCapture.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
task.spawn(function()
	...
	if success then
		if currentVersion ~= latestVersionInfo.Version then
			notify("Outdated", "Zyronis Panel: New version available!")
		end
